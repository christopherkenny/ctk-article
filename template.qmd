...
The magic refs div does not work by default in typst when `citeproc: false`, see [this issue](https://github.com/quarto-dev/quarto-cli/issues/8710).
This format, as of v1.1.0, bundles a filter [`typst-refs`](https://github.com/christopherkenny/typst-refs) to handle this.
Alternatively, if you are okay using a different citation processor, set `citeproc: true` in the YAML.
